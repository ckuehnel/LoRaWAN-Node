/*
 * File: Heltec_Lora32_ttn_otaa.ino
 * 
...
const char* devEui = "003503B7B19BFB5A"; // Change to TTN Device EUI
const char* appEui = "0000000000000000"; // Change to TTN Application EUI
const char* appKey = "D0ACEEDE748530DE882955080101EBD6";        // Change to TTN Application Key
...
{
    Serial.begin(115200);
    delay(2000); // wait fo serial monitor
    Serial.println("Starting");
    ttn.begin();
    ttn.onMessage(message); // Declare callback function for handling downlink
                            // messages from server
    //ttn.join(devEui, appEui, appKey);
    ttn.join("003503B7B19BFB5A", "0000000000000000", "D0ACEEDE748530DE882955080101EBD6");
